...
Создание файла в документе по контракту (УСН, ИОН)
--------------------------------------------------
...
**Описание параметров метода:**
    ...
    * В параметре type необходимо указать тип документа (USN, ION1, ION2, ION3, ION4, ION5). 
...
Создание и замена документа по контракту (УСН, ИОН)
---------------------------------------------------
